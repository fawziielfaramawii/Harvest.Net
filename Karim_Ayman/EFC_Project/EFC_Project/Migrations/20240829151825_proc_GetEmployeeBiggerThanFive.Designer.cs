...
namespace EFCProject.Migrations
{
    ...
    [Migration("20240829151825_proc_GetEmployeeBiggerThanFive")]
    partial class procGetEmployeeBiggerThanFive
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFC_Project.Model.Address", b =>
                {
            ...
            modelBuilder.Entity("EFC_Project.Model.Address", b =>
                {
                    b.HasOne("EFC_Project.Model.Employee", "Employee")
                        .WithOne("Address")
                        .HasForeignKey("EFC_Project.Model.Address", "EmployeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
